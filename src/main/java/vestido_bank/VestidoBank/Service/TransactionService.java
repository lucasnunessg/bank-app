...
public class TransactionService {
  ...
  @Autowired
  public TransactionService(ContaPoupancaRepository contaPoupancaRepository, ContaCorrenteRepository contaCorrenteRepository, TransactionsRepository transactionsRepository) {
  ...
  @Transactional
  public Transaction createTransactionWithPoupancaAndCorrente(Long contaPoupancaId, Long contaCorrenteId,
